	...
	<div id="container">
		...
		<form:form action="${ url }" modelAttribute="voter">
			...
			<div class="form-group row">
				...
				<div class="col-sm-4">
					<form:input path="sin" class="form-control" id="voterSin" maxlength="9" size="9" required="required"/>
				</div>
				<div class="col-sm-6">
					<c:if test="${not empty addVoterMessage }"><small><em>${ addVoterMessage }</em></small></c:if>
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-sm-4">
					<form:input path="birthday" class="form-control read-only" id="voterBirthday" required="required" readonly="true"/>
				</div>
			</div>
			...
			<div class="form-group row">
				<div class="col-sm-4">
					<input type="submit" value="Register Voter" class="btn btn-danger">
				</div>
			</div>
		</form:form>
	</div>
